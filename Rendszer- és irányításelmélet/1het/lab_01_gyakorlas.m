...
% stabil? nem, mert nem minden sajátérék valós része negatív
% tehát van a sajátértékek valós részei közt olyan, ami nem negatív

% van lengés? van lengés, mert a sajátérték nem tisztán valós,
% tehát komplex és van konjugált párja tehát az ugrásválaszban van lengés
...
rendszer = tf(2, [1, 11, 42.25, 54.75])

polusok = pole(rendszer)

zerusok = zero(rendszer)
...
rendszer = tf(2, conv(conv([3, 1], [5, 1]), [10, 1]))
